...
-- =============================================================================
-- Note: PostgreSQL uses a much simpler syntax to drop views if they exist.
...
WITH base_query AS (
    ...
    SELECT
        ...
        -- Calculate exact age in years using AGE() and EXTRACT()
...
SELECT
    ...
    total_sales,
    total_quantity,
    total_products, -- Fixed missing comma here
    lifespan,
